...
DB_PATH = os.path.join(os.path.dirname(__file__), 'database', 'iot_system.db')
...
def register_entry():
    ...
    try:
        ...
        # Envia Wake-on-LAN com IP para calcular broadcast correto
...
def register_exit():
    ...
    try:
        ...
        if shutdown_config.get('admin_username') and shutdown_config.get('admin_password'):
            credentials = {
